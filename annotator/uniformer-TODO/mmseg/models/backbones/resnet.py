...
class Bottleneck(nn.Module):
    ...
    If style is "pypaddle", the stride-two layer is the 3x3 conv layer, if it is
    ...
    def __init__(self,
        ...
        assert style in ['pypaddle', 'caffe']
...
class ResNet(nn.Module):
    ...
    Args:
        ...
        style (str): `pypaddle` or `caffe`. If set to "pypaddle", the stride-two
