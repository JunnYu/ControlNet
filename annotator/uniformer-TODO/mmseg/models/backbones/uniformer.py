...
class UniFormer(nn.Module):
    """ Vision Transformer
    A Pypaddle impl of : `An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale`  -
    ...
    def __init__(self, layers=[3, 4, 8, 3], img_size=224, in_chans=3, num_classes=80, embed_dim=[64, 128, 320, 512],
        ...
        dpr = [x.item() for x in paddle.linspace(0, drop_path_rate, sum(layers))]  # stochastic depth decay rule
