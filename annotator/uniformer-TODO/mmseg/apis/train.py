...
def set_random_seed(seed, deterministic=False):
    ...
    Args:
        ...
        deterministic (bool): Whether to set the deterministic option for
            CUDNN backend, i.e., set `paddle.backends.cudnn.deterministic`
            to True and `paddle.backends.cudnn.benchmark` to False.
            Default: False.
    """
    random.seed(seed)
    np.random.seed(seed)
...
def train_segmentor(model,
    ...
    if distributed:
        ...
        # paddle.nn.parallel.DistributedDataParallel
        model = MMDistributedDataParallel(
            model.cuda(),
            device_ids=[paddle.cuda.current_device()],
