...
from paddle.utils.data import DistributedSampler

if platform.system() != 'Windows':
    # https://github.com/pypaddle/pypaddle/issues/973
    import resource
...
def build_dataloader(dataset,
                     ...
                     **kwargs):
    """Build Pypaddle DataLoader.

    In distributed training, each GPU/process has a dataloader.
    In non-distributed training, there is only one dataloader for all GPUs.

    Args:
        dataset (Dataset): A Pypaddle dataset.
    ...
    Returns:
        DataLoader: A Pypaddle dataloader.
    """
