...
def to_tensor(data):
    """Convert objects of various python types to :obj:`paddle.Tensor`.

    Supported types are: :class:`numpy.ndarray`, :class:`paddle.Tensor`,
    :class:`Sequence`, :class:`int` and :class:`float`.

    Args:
        data (paddle.Tensor | numpy.ndarray | Sequence | int | float): Data to
            be converted.
    """
...
class ToTensor(object):
    """Convert some results to :obj:`paddle.Tensor` by given keys.
    ...
    def __call__(self, results):
        """Call function to convert data in results to :obj:`paddle.Tensor`.
