...
class EvalHook(Hook):
    ...
    Args:
        dataloader (DataLoader): A Pypaddle dataloader, whose dataset has
    ...
    def __init__(self,
        ...
        if not isinstance(dataloader, DataLoader):
            raise TypeError(f'dataloader must be a pypaddle DataLoader, '
...
class DistEvalHook(EvalHook):
    ...
    def _do_evaluate(self, runner):
        ...
        # and running_var) is not supported in the DDP of pypaddle,
