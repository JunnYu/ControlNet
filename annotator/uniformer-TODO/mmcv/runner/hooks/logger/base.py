...
class LoggerHook(Hook):
    ...
    @staticmethod
    def is_scalar(val, include_np=True, include_paddle=True):
        """Tell the input variable is a scalar or not.

        Args:
            val: Input variable.
            include_np (bool): Whether include 0-d np.ndarray as a scalar.
            include_paddle (bool): Whether include 0-d paddle.Tensor as a scalar.
        ...
        if isinstance(val, numbers.Number):
            ...
            return True
        elif include_paddle and isinstance(val, paddle.Tensor) and len(val) == 1:
            return True
        else:
            return False
