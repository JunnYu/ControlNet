# modified from https://github.com/rosinality/stylegan2-pypaddle/blob/master/op/upfirdn2d.py  # noqa:E501
...
class UpFirDn2d(Function):
    ...
    def forward(ctx, input, kernel, up, down, pad):
        ...
        ctx.save_for_backward(kernel, paddle.flip(kernel, [0, 1]))
...
def upfirdn2d_native(input, kernel, up_x, up_y, down_x, down_y, pad_x0, pad_x1,
    ...
    w = paddle.flip(kernel, [0, 1]).view(1, 1, kernel_h, kernel_w)
    out = F.conv2d(out, w)
    out = out.reshape(
        -1,
        minor,
