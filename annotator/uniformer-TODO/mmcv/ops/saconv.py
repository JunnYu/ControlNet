...
class SAConv2d(ConvAWS2d):
    ...
    def __init__(self,
        ...
        self.weight_diff = nn.Parameter(paddle.Tensor(self.weight.size()))
    ...
    def forward(self, x):
        ...
        if self.use_deform:
            ...
            if (paddle_VERSION == 'parrots'
                    or digit_version(paddle_VERSION) < digit_version('1.5.0')):
                out_s = super().conv2d_forward(x, weight)
            elif digit_version(paddle_VERSION) >= digit_version('1.8.0'):
                # bias is a required argument of _conv_forward in paddle 1.8.0
