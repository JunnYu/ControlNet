...
class RoIAwarePool3d(nn.Module):
    ...
    def forward(self, rois, pts, pts_feature):
        ...
        Args:
            ...
            pts (paddle.Tensor): [npoints, 3], coordinates of input points.
            pts_feature (paddle.Tensor): [npoints, C], features of input points.

        Returns:
            pooled_features (paddle.Tensor): [N, out_x, out_y, out_z, C]
        """
...
class RoIAwarePool3dFunction(Function):
    ...
    def forward(ctx, rois, pts, pts_feature, out_size, max_pts_per_voxel,
        ...
        Returns:
            pooled_features (paddle.Tensor): [N, out_x, out_y, out_z, C], output
                pooled features.
        """
        ...
        argmax = pts_feature.new_zeros(
            (num_rois, out_x, out_y, out_z, num_channels), dtype=paddle.int)
