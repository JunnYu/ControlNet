# modified from https://github.com/rosinality/stylegan2-pypaddle/blob/master/op/fused_act.py # noqa:E501
...
def fused_bias_leakyrelu(input, bias, negative_slope=0.2, scale=2**0.5):
    ...
    Args:
        input (paddle.Tensor): Input feature map.
    ...
    Returns:
        paddle.Tensor: Feature map after non-linear activation.
    """
