...
class CARAFENaiveFunction(Function):
    ...
    def backward(ctx, grad_output):
        ...
        grad_input = paddle.zeros_like(features)
        grad_masks = paddle.zeros_like(masks)
...
class CARAFEFunction(Function):
    ...
    def backward(ctx, grad_output):
        ...
        rgrad_output = paddle.zeros_like(grad_output, requires_grad=False)
        rgrad_input_hs = paddle.zeros_like(grad_output, requires_grad=False)
        rgrad_input = paddle.zeros_like(features, requires_grad=False)
        rgrad_masks = paddle.zeros_like(masks, requires_grad=False)
        grad_input = paddle.zeros_like(features, requires_grad=False)
        grad_masks = paddle.zeros_like(masks, requires_grad=False)
