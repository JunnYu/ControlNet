...
try:
    ...
    from .parrots_wrapper import (
        paddle_VERSION, BuildExtension, CppExtension, CUDAExtension, DataLoader,
        ...
        _MaxPoolNd, get_build_config, is_rocm_pypaddle, _get_cuda_home)
